...
import OrderListDisplayOptionWrapper from "./style";

interface OrderListDisplayOptionProps {
...
const OrderListDisplayOption = ({
  handleFilterChange,
  handleOrderChange,
  handleSortChange,
  categories,
}: OrderListDisplayOptionProps) => {
  const sortOption = [{ label: "Order date", value: "date" }];
  ...
  return (
    <OrderListDisplayOptionWrapper className="py-3">
    ...
    </OrderListDisplayOptionWrapper>
  );
};

export default OrderListDisplayOption;
